...
<head>
    ...
    <title>BloodBud| Contact Us</title>
...
.btn-primary{background-color: #f67280;
    border-color: #f67280;}
          .btn-primary:hover {
...
{ ?>
            <div class="col-lg-4 mb-4">
                ...
                <p>
                    <h6 title="Phone">Phone:</h6><?php   echo htmlentities($result->ContactNo); ?>
                </p>
                <p>
                    <h6 title="Email">Email:</h6> <a href="mailto:name@example.com"><?php   echo htmlentities($result->EmailId); ?>
                    </a>
                </p>
              <?php }} ?>
            </div>
