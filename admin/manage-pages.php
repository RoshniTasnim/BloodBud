...
<head>
	...
	<title>BloodBud | Admin Manage Pages</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=aboutus">Few Words</option> 
                  <option value="manage-pages.php?type=donor">Emergency Contacts</option>
                </select>
												</div>
											</div>
